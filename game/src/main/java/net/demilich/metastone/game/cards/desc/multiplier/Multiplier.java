...
public class Multiplier extends CustomCloneable implements IGameEventListener {
	...
	public Multiplier(CardCostModifierDesc desc) {
		this.desc = desc;
	...
	public Multiplier clone() {
		Multiplier clone = (Multiplier) super.clone();
