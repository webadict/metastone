...
public class SpellDeserializer implements JsonDeserializer<SpellDesc> {
	...
	public SpellDesc deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
		...
		parseArgument(SpellArg.BOARD_POSITION_RELATIVE, jsonData, spellArgs, ParseValueType.BOOLEAN);
        ...
        parseArgument(SpellArg.SOURCE, jsonData, spellArgs, ParseValueType.TARGET_REFERENCE);
        ...
        parseArgument(SpellArg.SUB_SPELL, jsonData, spellArgs, ParseValueType.SPELL);
